...
export default function EDirectorDetails({ refId,
    ...
    const handleFileUpload = (event, documentType, directorNumber) => {
    ...
    const handleEditDirector = async () => {
        ...
        try {
            ...
            // DIRECTOR 1
            // ------------------------------------
            const director1 = directorData?.[1];

            if (director1) {
                formData.append(
                    "director1Name",
                    director1.directorName || ""
                );

                formData.append(
                    "director1Designation",
                    director1.directorDesignation || ""
                );

                formData.append(
                    "director1AadharNo",
                    director1.directorAadharNo || ""
                );

                formData.append(
                    "director1PanNo",
                    director1.directorPanNo || ""
                );

                // New uploaded files only
                if (uploadedFiles?.[1]?.selfie) {
                    formData.append(
                        "director1Selfie",
                        uploadedFiles[1].selfie
                    );
                }
                if (uploadedFiles?.[1]?.pan) {
                    formData.append(
                        "director1Pan",
                        uploadedFiles[1].pan
                    );
                }
                if (uploadedFiles?.[1]?.aadhar) {
                    formData.append(
                        "director1Aadhar",
                        uploadedFiles[1].aadhar
                    );
                }
            }
            ...
            // DIRECTOR 2
            // ------------------------------------
            const director2 = directorData?.[2];

            if (director2) {
                formData.append(
                    "director2Name",
                    director2.directorName || ""
                );

                formData.append(
                    "director2Designation",
                    director2.directorDesignation || ""
                );

                formData.append(
                    "director2AadharNo",
                    director2.directorAadharNo || ""
                );

                formData.append(
                    "director2PanNo",
                    director2.directorPanNo || ""
                );

                // New uploaded files only
                if (uploadedFiles?.[2]?.selfie) {
                    formData.append(
                        "director2Selfie",
                        uploadedFiles[2].selfie
                    );
                }

                if (uploadedFiles?.[2]?.pan) {
                    formData.append(
                        "director2Pan",
                        uploadedFiles[2].pan
                    );
                ...
                if (uploadedFiles?.[2]?.aadhar) {
                    formData.append(
                        "director2Aadhar",
                        uploadedFiles[2].aadhar
                    );
                }
            }
                            ...
                            <div className="p-3 sm:p-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            <BriefcaseBusiness className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#1169ad] pointer-events-none z-10" />
                                            ...
                                            <select
                                                ...
                                                className="appearance-none w-full h-10 pl-9 pr-8 text-xs text-gray-600 bg-white border border-gray-200 rounded-lg outline-none focus:border-[#1677c8] focus:ring-1 focus:ring-[#1677c8] cursor-pointer"
                                            >
                                            ...
                                            <div className="w-full flex items-center justify-between">
                                                ...
                                                <div className="flex items-center min-w-0">
                                                    ...
                                                    <span className="ml-2 text-xs text-gray-400 truncate">
                                                        {uploadedFiles?.[directorNumber]?.selfie?.name ||
                                                            selfie?.fileName ||
                                                ...
                                                <div className="mr-2 flex items-center gap-1">
                                                    ...
                                                    >
                                                        ...
                                                        <input
                                                            ...
                                                            accept="image/*"
                                                            onChange={(e) =>
                                                                handleFileUpload(e, "selfie", directorNumber)
                                                            }
                                                        />
                                                    </label>
                                                </div>
                                        ...
                                        <label className="relative flex items-center h-10 w-full border border-gray-200 rounded-lg bg-white cursor-pointer hover:border-[#1677c8] transition">
                                            <div className="w-full flex items-center justify-between">
                                                ...
                                                <div className="flex items-center min-w-0">
                                                    <FileText className="w-4 h-4 ml-3 text-gray-300 shrink-0" />
                                                    <span className="ml-2 text-xs text-gray-400 truncate">
                                                        {uploadedFiles?.[directorNumber]?.pan?.name ||
                                                            pan?.fileName ||
                                                ...
                                                <div className="mr-2 flex items-center gap-1">
                                                    ...
                                                    >
                                                        ...
                                                        <input
                                                            ...
                                                            onChange={(e) =>
                                                                handleFileUpload(e, "pan", directorNumber)
                                                            }
                                                        />
                                                    </label>
                                                </div>
                                        ...
                                        <label className="relative flex items-center h-10 w-full border border-gray-200 rounded-lg bg-white cursor-pointer hover:border-[#1677c8] transition">
                                            <div className="w-full flex items-center justify-between">
                                                ...
                                                <div className="flex items-center min-w-0">
                                                    <FileText className="w-4 h-4 ml-3 text-gray-300 shrink-0" />
                                                    <span className="ml-2 text-xs text-gray-400 truncate">
                                                        {uploadedFiles?.[directorNumber]?.aadhar?.name ||
                                                            aadhar?.fileName ||
                                                ...
                                                <div className="mr-2 flex items-center gap-1">
                                                    ...
                                                    >
                                                        ...
                                                        <input
                                                            ...
                                                            accept=".pdf,.jpg,.jpeg,.png"
                                                            onChange={(e) =>
                                                                handleFileUpload(e, "aadhar", directorNumber)
                                                            }
                                                        />
                                                    </label>
                                                </div>
