...
export default function ResellerBasicDetails() {
    ...
    const viewResellers = async () => {
        try {
            ...
            if (response?.respCode === 0) {
                ...
                console.log("SUCCESS DATA:", response?.respData?.[0]);
            } else {
    ...
    // ─── Reseller Edit Save Api ─────────────────────────────────────────────────────────────
    const resellerUpdateDetails = async () => {
        try {
        ...
        <>
            ...
            >                {/*Header Section*/}
                <div>
                    ...
                    <p className="pb-3 text-lg text-blue-900">Edit and update reseller details securely, including profile information, business data, and account settings with controlled validation.
                    </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-4">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            className="w-full h-9 py-2 border border-gray-400 rounded-sm bg-white px-3 text-sm text-gray-600 outline-none"
                        >
