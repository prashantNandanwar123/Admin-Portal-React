  ...
  return (
    <>
      ...
      >
        ...
        <p className="text-sm text-blue-900 leading-relaxed font-noraml">
        ...
        <div className="py-5">
          <div className="border-t border-gray-300 pt-3">
            <h2 className="text-[18px] text-[#5c5c5c] mb-4">
              Fee Setup
            </h2>
        ...
        <div className="border-t border-gray-300 pt-4">
          <h2 className="text-[18px] text-[#5c5c5c] mb-5">Settlement Setup</h2>
        ...
        {/* ── Miscellaneous ─────────────────────────────────────────────── */}
        <section className="border-t border-gray-300 pt-4 mt-5">
          <h2 className="text-2xl font-semibold text-gray-700 mb-6">
            Miscellaneous
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
